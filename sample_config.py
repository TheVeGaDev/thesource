...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/TheVeGaDev/thesource"
    )
    ...
    ZELZAL_Z = int(1260465030)
    ZELZAL_A = int(os.environ.get("ZELZAL_A") or -1002210064347)
    ...
    OLDZED_REPO = os.environ.get("OLDZED_REPO", "https://github.com/TheVeGaDev/thesource")
    if OLDZED_REPO and not url(OLDZED_REPO):
        OLDZED_REPO = "https://github.com/TheVeGaDev/thesource"
