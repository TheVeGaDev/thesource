...
Malath = f"**☆┊لـَوحـة أوامـِر TEᑭTᕼOᑎ الشفـافَـة**\n**☆┊المستخـِدم ↶** {mention} \n\n**☆┊لـࢪؤية شـࢪح أي امـࢪ ↓ اضغـط عليـه**"
TG_BOT = Config.TG_BOT_USERNAME
TM = time.strftime("%I:%M")
Channels = f"**•❐•  مرحبـًا عـزيـزي  {mention} **\n**•❐• إليـك مجمـوعــة قنـوات تيــبــثـون ↵ 𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡 ♥️🧸**\n\n**•❐• استـخـدم الازرار بالاسفــل↓**"
Zelzal = f"**•◈• إصــدار الســورس ⤽ 2.0**  \n**•◈• المستخــدم ⤽**  {mention}  \n**•◈• وقــت التشغيــل ⤽  {TM}  **\n**•◈• البــوت المســاعـد ⤽  {TG_BOT} **\n**•◈• قنــاة الســورس ⤽  @𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡 **"

# القائمة الرئيسية مع 19 زرًا
def get_main_menu_buttons():
    return [
        [Button.inline("⛥ ١", data="ahmed1"), Button.inline("⛥ ٢", data="ahmed2"), 
         Button.inline("⛥ ٣", data="ahmed3"), Button.inline("⛥ ٤", data="ahmed4")],
        [Button.inline("⛥ ٥", data="ahmed5"), Button.inline("⛥ ٦", data="ahmed6"), 
         Button.inline("⛥ ٧", data="ahmed7"), Button.inline("⛥ ٨", data="ahmed8")],
        [Button.inline("⛥ ٩", data="ahmed9"), Button.inline("⛥ ١٠", data="ahmad10"), 
         Button.inline("⛥ ١١", data="ahmad11"), Button.inline("⛥ ١٢", data="ahmad12")],
        [Button.inline("⛥ ١٣", data="ahmad13"), Button.inline("⛥ ١٤", data="ahmad14"), 
         Button.inline("⛥ ١٥", data="ahmad15"), Button.inline("⛥ ١٦", data="ahmad16")],
        [Button.inline("⛥ ١٧", data="ahmad17"), Button.inline("⛥ ١٨", data="ahmad18"), 
         Button.inline("⛥ ١٩", data="ahmad19"), Button.inline("إغلاق", data="close")]
    ]
...
# دوال معالجة الأزرار
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"close")))
@check_owner
async def close_handler(event):
    await event.delete()

@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"back_to_main")))
@check_owner
async def back_to_main_handler(event):
    ...
    try:
        ...
        await event.answer(f"حدث خطأ: {str(e)}", cache_time=0, alert=True)

# دوال الأزرار من 1 إلى 19 مع زر الرجوع إلى القائمة الرئيسية
...
async def zed_handler(event):
    ...
    query = event.text
    await zedub.get_me()
    if query.startswith("فيجاثون") and event.query.user_id == zedub.uid:
        ZPIC = gvarstatus("ALIVE_PIC")
        buttons = [[Button.url("سورس فيجاثون العربي - 𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡 USERBOT", "https://t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡"),],[Button.url("التحـديثـات", "https://t.me/Tws_𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡"), Button.url("الفـارات", "https://t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡e1"),],[Button.url("الشـروحـات¹", "https://t.me/Tws_𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡"),],[Button.url("كــلايــش تــيــبــثون", "https://t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡klaesh"),],[Button.url("مطـور السـورس", "https://t.me/PPF22"),]]
...
async def zed_handler(event):
    zelzal = "⤶ عذرًا عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحة لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الأوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
    text = "[ᯓ 𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامـِـࢪ البـــوت 🦾🤖](t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡) .\n\n**⎞𝟏⎝** `.اعاده تشغيل`\n**لـ لتـرسيت وإعـادة تشغيـل البـوت**\n\n**⎞𝟐⎝** `.ايقاف البوت`\n**لـ ايقـاف البـوت عـن العمـل والغـاء التنصـيب**\n\n**⎞𝟑⎝** `.تحديث`\n**لـ البحـث عـن تحديثـات وتحديث البـوت**\n\n**⎞𝟒⎝** `.تحديث الان`\n**لـ التحـديث الاولـي لـ البـوت لـ التنصيـب الثـانوي**\n\n**⎞𝟓⎝** `.تحديث البوت`\n**لـ التحـديث الثـانوي لـ البـوت لـ التنصيـب الاولـي والثـانوي**\n\n**⎞𝟔⎝** `.فحص`\n**لـ فحص قاعدة البيانات وعـرض اصـدار السورس ولغة بايثـون ومكتبة تيليثون**\n\n**⎞𝟕⎝** `.سليب` او `.سليب_ميديا`\n**لـ جعل البـوت في وضع النـوم او الإسبات ويتم ايقافه عند ارسالك لـ اي رسالة**\n\n**⎞𝟖⎝** `.الانترنت` او `.الانترنت صورة`\n**لـ عرض سرعة الانتـرنت (الرفـع & التحميـل) في سيرفـر البوت الخاص بك**\n\n**⎞𝟗⎝** `.المساعد`\n**لـ عـرض قائمـة أوامـر المطـور المسـاعد**\n\n**⎞𝟏𝟎⎝** `.الاذاعه`\n**لـ عـرض أوامـر الاذاعـه والتوجيـه**\n\n**⎞𝟏𝟏⎝** `.النظام`\n**لـ لعـرض معلومـات نظـام البـوت الخـاص بك**\n\n**⎞𝟏𝟐⎝** `.السرعه`\n**لـ قياس سرعة الرفع والتحميل في سيرفر البوت الخاص بك**\n\n**⎞𝟏𝟑⎝** `.فرمته`\n**لـ حذف المجلدات والملفات والعمليات المخزنه مؤقتـاً في سيرفر البوت الخاص بك**\n\n**⎞𝟏𝟒⎝** `.فاراتي`\n**لـ عـرض جميـع فارات تنصيبك**\n\n**⎞𝟏𝟓⎝** `.تاريخ التنصيب`\n**لـ عـرض تاريـخ بـدء تنصيبك على سـورس تيبثـون**\n\n**•❐• لعـرض اصـدار السـورس أرسل** `.سورس`\n**•❐• لعـرض قنـوات السـورس أرسل** `.فيجاثون`\n\n\n 𓆩 [𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡) 𓆪"
    zilzal = [[Button.inline("رجــوع ↪️", data="back_to_main")]]
    try:
...
async def zed_handler(event):
    ...
    text = "[ᯓ 𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامـِـࢪ الوقتـــي ⌚️](t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⎞𝟏⎝** `.الاسم تلقائي`\n\n**⎞𝟐⎝** `.البايو تلقائي`\n\n**⎞𝟑⎝** `.البروفايل تلقائي` \n\n**⎞𝟒⎝** `.انهاء الاسم` / `.انهاء البايو` / `.انهاء البروفايل`\n\n**⎞𝟓⎝** `.اوامر الوقتي`\n\n\n 𓆩 [𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡) 𓆪"
    zilzal = [[Button.inline("رجــوع ↪️", data="back_to_main")]]
    try:
        await event.edit(text, buttons=zilzal, link_preview=False)
    except Exception:
...
async def zed_handler(event):
    zelzal = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحة لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الأوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
    text = "[ᯓ 𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامـِـࢪ المجمــوعــه¹](t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⎞𝟏⎝** `.البوتات`\n\n**⎞𝟐⎝** `.قفل البوتات` / `.فتح البوتات`\n\n**⎞𝟑⎝** `.قفل الاضافه` / `.فتح الاضافه`  \n\n**⎞𝟒⎝** `.قفل الدخول` / `.فتح الدخول `\n\n**⎞𝟓⎝** `.قفل الميديا` / `.فتح الميديا `\n\n**⎞𝟓⎝** `.قفل تعديل الميديا` / `.فتح تعديل الميديا `\n\n**⎞𝟔⎝** `.قفل الفشار` / `.فتح الفشار`\n\n**⎞𝟕⎝** `.قفل الفارسيه` / `.فتح الفارسيه`\n\n**⎞𝟖⎝** `.قفل الروابط` / `.فتح الروابط`\n\n**⎞𝟗⎝**`.قفل المعرفات` / `.فتح المعرفات`\n\n**⎞𝟏𝟎⎝** `.قفل التوجيه` / `.فتح التوجيه`\n\n**⎞𝟏𝟏⎝** `.قفل الانلاين` / `.فتح الانلاين`\n\n**⎞𝟏𝟐⎝** `.قفل الكل` / `.فتح الكل`\n\n**⎞𝟏𝟑⎝** `.قيد`   لتقييـد المحتـوى\n\n**⎞𝟏𝟒⎝** `.الاعدادات`\n\n\n 𓆩 [𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡) 𓆪"
    zilzal = [[Button.inline("رجــوع ↪️", data="back_to_main")]]
    try:
        await event.edit(text, buttons=zilzal, link_preview=False)
    except Exception:
...
async def zed_handler(event):
    zelzal = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحة لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الأوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
    text = "[ᯓ 𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامـِـࢪ الحســاب 🚹](t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⎞𝟏⎝** `.ايدي` او `.ا`\n**⦇.ايدي بالـرد او + معـرف/ايـدي الشخص⦈ لـ عـرض معلومـات الشخـص**\n\n**⎞𝟐⎝** `.الايدي`\n**⦇.الايدي بالـرد⦈ لـ جلـب ايـدي الشخـص والكـروب**\n\n**⎞𝟑⎝** `.حزمة`\n**⦇.صورته بالـرد / .صورته الكل بالـرد⦈ لـ جـلب جميـع بروفـايلات الشخـص**\n\n**⎞𝟒⎝** `.اسمي` / `.اسمه`\n**⦇.اسمه بالـرد⦈ لـ جـلب اسـم الشخـص**\n\n**⎞𝟓⎝** `.الاسماء`\n**⦇.الاسماء بالـرد / .الاسماء + معـرف او ايدي الشخـص⦈ لـ جـلب قائمـة بسجـل اسمـاء حسـاب الشخـص**\n\n**⎞𝟔⎝** `.المعرفات`\n**⦇.المعرفات بالـرد / .المعرفات + معـرف او ايدي الشخـص⦈ لـ جـلب قائمـة بسجـل معـرفـات حسـاب الشخـص**\n\n**⎞𝟕⎝** `.تخزين الخاص تفعيل`\n**⦇الامـر + تفعيل او تعطيل⦈ لـ تخـزين جميـع رسـائل الخـاص بـ كـروب التخـزين**\n\n**⎞𝟖⎝** `.تخزين الكروبات تفعيل`\n**⦇الامـر + تفعيل او تعطيل⦈ لـ تخـزين جميـع تاكـات المـجـموعات بـ كـروب التخـزين**\n\n\n**- اوامـِـࢪ حمـايــة الخــاص🛡 :**\n\n**⎞𝟗⎝** `.الحمايه تفعيل`\n**لـ تفعيـل حمايـة الخـاص لـ حسـابك**\n\n**⎞𝟏𝟎⎝** `.الحمايه تعطيل`\n**لـ تعطيـل حمايـة الخـاص لـ حسـابك**\n\n**⎞𝟏𝟏⎝** `.قبول`\n**لـ السمـاح لـ الشخـص بـ ارسـال رسـائل الخـاص اثنـاء تفعيـل حمـاية الخـاص بحسـابك بـدون تحـذير**\n\n**⎞𝟏𝟐⎝** `.رفض`\n**لـ رفـض الشخـص من ارسـال رسـائل الخـاص اثنـاء تفعيـل حمـاية الخـاص بحسـابك**\n\n**⎞𝟏𝟑⎝** `.مرفوض`\n**لـ حظـر الشخـص من الخـاص دون تحـذير**\n\n**⎞𝟏𝟒⎝** `.المقبولين`\n**لـ عـرض قائمـة بالاشخـاص المقبـولين**\n\n\n**- اوامـِـࢪ الحظــر - الكتــم - الطــرد 🔕 :**\n\n**⎞𝟏𝟓⎝** `.حظر`  /  `.الغاء حظر`\n\n**⎞𝟏𝟔⎝** `.كتم`  /  `.الغاء كتم`\n\n**⎞𝟏𝟕⎝** `.طرد`\n\n**⎞𝟏𝟖⎝** `.ح عام`\n\n**⎞𝟏𝟗⎝** `.الغاء ح عام`\n\n**⎞𝟐𝟎⎝** `.ك عام`\n\n**⎞𝟐𝟏⎝** `.الغاء ك عام`\n\n**⎞𝟐𝟐⎝** `.ط عام`\n\n**⎞𝟐𝟑⎝** `.الحاظرهم`\n**لـ جلب قائمـه بالاشخاص المحظورين خاص**\n\n**⎞𝟐𝟒⎝** `.رسائلي` / `.رسائله`\n**لـ عـرض عـدد رسائلك او رسائل شخص في المجمـوعـة**\n\n**⎞𝟐𝟓⎝** `.حذف رسائلي` + عـدد\n**لـ حـذف رسائلك من المجمـوعـة**\n\n**⎞𝟐𝟔⎝** `.احذف` + معـرف\n**لـ حذف دردشـة مع شخص من الخاص**"
    zilzal = [[Button.inline("رجــوع ↪️", data="back_to_main")]]
    try:
        await event.edit(text, buttons=zilzal, link_preview=False)
    except Exception:
...
async def zed_handler(event):
    zelzal = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحة لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة الأوامـر هنـا 👇\n\n⤶ ارســل (.اوامري)"
    text = "[ᯓ 𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامـِـࢪ تحـويـل الصيــغ 💡🎞](t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⎞𝟏⎝** `.ملصق`\n\n**⎞𝟐⎝** `.حزمه`\n\n**⎞𝟑⎝** `.حزمة`\n\n**⎞𝟒⎝** `.معلومات الملصق`\n\n**⎞𝟓⎝** `.ملصقات`\n\n**⎞𝟔⎝** `.لملصق`\n\n**⎞𝟕⎝** `.لصوره`\n\n**⎞𝟖⎝** `.لفيد`\n\n**⎞𝟗⎝** `.دائري`\n\n**⎞𝟏𝟎⎝** `.لمتحركة`\n\n**⎞𝟏𝟏⎝** `.حول بصمه`\n\n**⎞𝟏𝟑⎝** `.حول صوت`\n\n**⎞𝟏𝟒⎝** `.لمتحركه`\n\n**⎞𝟏𝟓⎝** `.لمتحرك`\n\n\n 𓆩 [𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡) 𓆪"
    zilzal = [[Button.inline("رجــوع ↪️", data="back_to_main")]]
    try:
        await event.edit(text, buttons=zilzal, link_preview=False)
    except Exception:
...
async def zed_handler(event):
    ...
    if query.startswith("السورس") and event.query.user_id == zedub.uid:
        ZPIC = gvarstatus("ALIVE_PIC")
        buttons = [[Button.url("سورس فيجاثون العربي - 𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡 USERBOT", "https://t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡")]]
...
async def zed_handler(event):
    ...
    if query.startswith("اليدوي") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("اضغــط هنــا", "https://t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡e1")]]
...
async def zed_handler(event):
    ...
    if query.startswith("الفيزا") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("اضغــط هنــا", "https://t.me/Visa𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡")]]
        result = builder.article(title="zedub",text=zelzal,buttons=buttons,link_preview=False)
        await event.answer([result] if result else None)
...
async def zed_handler(event):
    ...
    if query.startswith("الهيروكو") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("اضغــط هنــا", "https://t.me/Tws_𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡/59")]]
        result = builder.article(title="zedub",text=zelzal,buttons=buttons,link_preview=False)
        await event.answer([result] if result else None)
...
async def zed_handler(event):
    ...
    if query.startswith("التنصيب") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("اضغــط هنــا", "https://t.me/𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡/134")]]
        result = builder.article(title="zedub",text=zelzal,buttons=buttons,link_preview=False)
        await event.answer([result] if result else None)
...
async def zed_handler(event):
    ...
    if query.startswith("يدوي") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("اضغــط هنــا", "https://t.me/Tws_𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡/63")]]
        result = builder.article(title="zedub",text=zelzal,buttons=buttons,link_preview=False)
        await event.answer([result] if result else None)
